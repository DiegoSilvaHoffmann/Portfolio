function mira_datos(){
    ...
    let ver = window.open("", "visualizar", "width=280, height=600")
        ...
        ver.document.write("<div class='datos_part1'><p>" + nombre + " " + apellido + "</p></div>")
        ver.document.write("<p>" + email + '</p><br>')
        ver.document.write('<p>' + fecha + '</p>')
